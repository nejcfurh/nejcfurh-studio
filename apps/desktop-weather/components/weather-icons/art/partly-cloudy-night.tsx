...
export const PartlyCloudyNightArt = ({
  uid
        ...
        <g>
          ...
          <g mask={`url(#${uid}-mask0)`}>
            <g>
              <path
                fill="currentColor"
                d="M35.766 34C29.15 34.714 24 40.241 24 46.959 24 54.16 29.918 60 37.218 60 43.37 60 48.527 55.846 50 50.23c-8.783.941-16.523-7.51-14.234-16.23"
              />
              <animateTransform
                attributeName="transform"
                begin="0s"
                ...
                repeatCount="indefinite"
                type="rotate"
                values="-6 37.0 47.0;6 37.0 47.0;-6 37.0 47.0"
              />
            </g>
          </g>
        </g>
